...
**Cara pakai file ini**
- Bagian A: tabel per regulasi (pasal → isi → implikasi aplikasi → tahap T1–T5). Tahap mengikuti tahapan kanonis `docs/planning/04` (revisi 2026-09-14): T1 Purwarupa Hitung dan Rekomendasi, T2 Vision Tracker dan Optimasi Simpang, T3 Deteksi Kejadian dan Pemantauan Operasional, T4 Kendali Adaptif Terpadu, T5 Platform Mobilitas Kota. Kolom tahap di bagian A dan B diselaraskan pada 2026-09-15 dengan `docs/planning/04` dan `05`; nilai yang berubah ditandai "(dulu …)" menurut skema lama 2026-09-12 (T1 MVP monitoring, T2 siap jual, T3 transisi adaptif, T4 setara ITCS, T5 end-state). Bila bertentangan dengan `docs/planning/05`, ikuti `05`.
...
| 13, 321 | Forum LLAJ koordinasi antarinstansi | Laporan MRLL ke Forum; entitas stakeholder | **T3** (dulu T2) |
| 25–28, 275 | Jalan wajib berperlengkapan (APILL, alat pengawasan); dilarang mengganggu fungsi; sanksi | Inventaris aset; log gangguan/vandalisme | **T3** (dulu T1) |
...
| 95, 102 | Kebijakan lalu lintas via Permen/Perda dan dinyatakan dengan APILL/rambu/marka; pemasangan ≤60 hari; **berlaku mengikat 30 hari setelah pemasangan** | Atribut tanggal pasang & tanggal berlaku hukum per aset | **T3** (dulu T1) |
| 96(3)–(4), 97 | Gubernur bertanggung jawab MRLL jalan provinsi setelah rekomendasi instansi; Kapolri bertanggung jawab optimalisasi operasional & pengawasan; Polri boleh MRLL sementara saat situasional | Workflow rekomendasi; mode "operasional Polri" tercatat | **T3** (alur rekomendasi), **T4** (mode operasional Polri) (dulu T2) |
| 98 | Penanggung jawab MRLL wajib analisis, evaluasi, laporan berbasis data & kinerja ke Forum LLAJ | Modul laporan kinerja periodik | **T3** (dulu T2) |
...
| 104, 282 | Perintah petugas Polri diutamakan atas APILL | **Mode manual/override petugas** dengan log | **T4** (dulu T1) |
| 106(4)c, 287(2) | Pengemudi wajib patuh APILL; sanksi kurungan ≤2 bulan/denda ≤Rp500 rb | Bukti pelanggaran → Polri | **T3** (bukti tanpa pelat), T4 (ETLE) (dulu T4) |
| 133 | MKLL: kriteria V/C, angkutan umum, lingkungan; retribusi pengendalian (ERP); evaluasi berkala | Data pendukung TDM/ERP | T5 |
| 134–135(3) | Kendaraan hak utama; APILL tidak berlaku bagi mereka | Preemption/priority darurat | T3 (deteksi kendaraan prioritas), T4 (preemption) (dulu T3–T4) |
...
| 250, 251 | Data pusat kendali **harus dapat diakses masyarakat**; SIK untuk penegakan hukum oleh Polri | Portal/API publik (dengan pengecualian data pribadi) | **T3** (dashboard publik), **T5** (API publik) (dulu T2) |
...
|---|---|---|---|
| 2, 5 | Tanggung jawab per status jalan; gubernur setelah rekomendasi Kemenhub/PU/Polri; koordinasi provinsi berbatasan | Atribut status jalan; workflow rekomendasi; multi-yurisdiksi Bodetabek | T1 (atribut status jalan), **T3** (alur rekomendasi), **T4** (multi-yurisdiksi) (dulu T1) |
| 7, 9 | Identifikasi masalah & inventarisasi (volume, komposisi, variasi, arah, pengaturan, kecepatan & tundaan, kinerja perlengkapan, prakiraan) | Skema data survei & perlengkapan | T1 (arus dan geometri), **T3** (perlengkapan) (dulu T1) |
...
| 24, 27 | Perintah/larangan per ruas provinsi = keputusan gubernur; wajib diinformasikan | Arsip SK & sosialisasi | **T3** (dulu T2) |
| 31 | Pemeliharaan: **memantau keberadaan & kinerja perlengkapan jalan** | Modul kesehatan aset | **T3** (dulu T1) |
| 34–35 | Optimalisasi operasional saat situasional/**APILL tidak berfungsi**/prioritas/pekerjaan jalan/kecelakaan → dilaksanakan Polri dengan APILL sementara | Notifikasi kegagalan ke Polri; event khusus | **T3** (dulu T2) |
| 44, 46 | Pengawasan gubernur (efektivitas kebijakan); penegakan Polri langsung/elektronik | Laporan efektivitas; ETLE ranah Polri | **T3**/T4 (dulu T2/T4) |
...
| Pasal | Isi | Implikasi | Tahap |
|---|---|---|---|
| PP 79 Ps.42–43 | Jenis APILL 3/2/1 warna; susunan; makna warna termasuk merah+kuning | Sama dengan PM 49 (turunannya) | **T2** (pembacaan nyala lampu), **T4** (model controller) (dulu T1) |
| PP 79 Ps.26 huruf c, f | Perlengkapan jalan: APILL; alat pengawasan & pengamanan (timbangan) | Alat pengawasan ≠ CCTV lalu lintas | — |
| PP 37/2011 | Forum LLAJ: tugas koordinasi, keanggotaan | Stakeholder & pelaporan | **T3** (dulu T2) |

### A.4 Permenhub PM 96/2015 (Pedoman MRLL)
| Bagian | Isi | Implikasi | Tahap |
|---|---|---|---|
| Ps.1(4) | MRLL oleh pejabat/petugas berkompetensi | Manajemen pengguna & kualifikasi | **T3** (dulu T1) |
| **Ps.5(2)–(3)** | MRLL di jalan nasional DKI oleh gubernur setelah **persetujuan Dirjen Hubdat** (perencanaan & perekayasaan) | Flag simpang jalan nasional; workflow persetujuan | T1 (penanda jalan nasional), **T3** (alur persetujuan) (dulu T1) |
...
| Lamp.I Bab II.E | Alternatif penanganan **wajib disimulasikan sebelum ditetapkan** | Simulasi (SUMO) sebelum deploy plan | **T2** (dulu T3) |
| Lamp.I Bab III–IV | Penetapan lokasi/jenis APILL via Keputusan Gubernur; wajib sosialisasi; **uji coba pengoperasian APILL** saat pemasangan | Arsip SK; checklist commissioning | **T3** (arsip SK), **T4** (commissioning perangkat) (dulu T1) |
| Lamp.I Bab VI | Monev = LOS sebelum vs sesudah; tindakan korektif | Modul before–after | T2 (eksisting vs rekomendasi), **T3** (sebelum-sesudah lapangan) (dulu T2) |
| Lamp.II.A, D | Prioritas angkutan massal: **bus priority di simpang ber-APILL**; hijau khusus angkutan umum & pejalan kaki | Fitur TSP | **T4** (dulu T3) |
| Lamp.II.F.b | Warrant APILL (750/8 jam; >30 s; 175 ped; 5 laka) | Modul kelayakan | **T3** (dulu T2) |
| Lamp.II.F.d | APILL otonom adaptif wajib detektor | Health check sebelum mode adaptif | **T4** (dulu T3) |
| Lamp.II.F.e | ATCS ≥3 simpang, ≤1 km, detektor, komunikasi, Control Centre Room; opsional kamera, DIS, VMS, detektor bus, fase bus priority, pemantau kecepatan/volume | Corridor grouping & inventaris | **T3** (inventaris), **T4** (pengelompokan koridor) (dulu T2) |
| Lamp.II.F.g | ITS di simpang ber-ATCS: pemantau kecepatan/volume + media informasi | Modul ATIS | T2 (volume), **T3** (kecepatan dan informasi publik) (dulu T2) |
...
| Lamp.III | Kajian ke Dirjen minimal kecepatan rata-rata & V/C; laporan ≥1×/tahun; evaluasi Dirjen | Template kajian & laporan tahunan | **T3** (dulu T2) |

### A.5 Permenhub PM 49/2014 (APILL) — pasal rekonstruksi
| Pasal | Isi | Implikasi | Tahap |
|---|---|---|---|
| 3–10 | Jenis, fungsi, makna warna (merah+kuning), susunan | State machine head | **T2** (pembacaan nyala lampu), **T4** (model controller) (dulu T1) |
| 4, 11–12 | Otonom vs terkoordinasi; siklus terkoordinasi = skema antar-APILL oleh **sistem terpusat** | Dasar ATCS/ITCS terpusat | **T4** (dulu T2) |
| 13–16 | Siklus tetap **≥8 rencana**; semi-adaptif; adaptif | Mode kendali & fallback TOD | **T2** (≥8 jadwal rekomendasi), **T4** (mode kendali dan fallback) (dulu T1) |
| 17–18 | 12 aspek makro/mikro penentuan siklus; tata cara oleh Dirjen | Dokumentasi algoritma; rujuk PKJI/Dirjen 273 | T2 (mode optimasi), **T4** (algoritme adaptif) (dulu T2) |
| 19–24 | Komponen; controller 5–70 °C, RH ≤95% | Atribut aset | **T3** (dulu T1) |
| 25 | Boleh dipasangi detektor, kamera, DIS, perangkat TI **bersertifikat** | Atribut sertifikasi per perangkat | **T3** (atribut aset), **T4** (perangkat edge) (dulu T1) |
| 27–28 | Penyelenggaraan oleh Dirjen (nasional/perpotongan)/gubernur (provinsi)/tol (BUJT) | Peta kewenangan per simpang | T1 |
| 29–39 | Penempatan & tinggi (≥300/175–265/≥500 cm), ≤3 armatur/tiang | Checklist inspeksi | **T3** (dulu T1) |
| 41 | Pemeliharaan berkala **≥6 bulan**; insidentil termasuk **penyesuaian siklus dengan arus aktual** | Jadwal PM; log re-timing | **T3** (dulu T1) |
| 42 | Umur teknis ≤5 tahun; penghapusan berdasarkan penilaian kinerja | Asset life cycle | **T3** (dulu T1) |
| 43–45 | Pembuat terdaftar Ditjen; peralihan 2 tahun; pembinaan Dirjen | Atribut pabrikan | **T3** (dulu T1) |
...
| 4(5)–(6), 5 | Data → dasar MRLL/MKLL & informasi masyarakat; tujuan real time | ATIS publik | **T3** (dulu T2) |
| 6 | 12 jenis SMTC | Roadmap modul | — |
| **7** | ATMS: subsistem ATCS, pemantauan real time, VMS, kecelakaan, jalan penghubung, ETLE, waktu tempuh, prioritas bus; **prinsip: semua perangkat terhubung ke ruang kendali & dapat disetel dari ruang kendali**; layanan prioritas kendaraan khusus, pemantauan visual, informasi, penindakan, **deteksi kerusakan dari ruang kendali, rekaman operasional & historis**, deteksi kecepatan | Daftar modul minimal & requirement arsitektur terpusat | **T3–T4** (dulu T2–T4) |
| 8 | ATIS: kepadatan, jalur alternatif, parkir, cuaca; daring/ponsel/rambu | Portal publik | **T3** (dulu T2) |
| 11 | APTS: **sinyal prioritas bus untuk perubahan fase**; kurangi tundaan angkutan umum | TSP | **T4** (dulu T3) |
...
| 20–21 | Integrasi dengan sistem K/L & pemda; wajib **unit kerja pengelola & SDM kompeten** | Persyaratan organisasi pembeli | **T3** (unit pengelola dan SDM), **T4** (integrasi K/L) (dulu T2) |
| 22–24 | Pembinaan & pengawasan (penilaian efektivitas, koreksi) | Laporan efektivitas | **T4** (dulu T2) |

### A.7 Perda DKI 5/2014 (Transportasi)
| Pasal | Isi | Implikasi | Tahap |
|---|---|---|---|
| 8–10 | Target **60% KBU & 35 km/jam**; Renstra 5 tahun; RIT evaluasi 5 tahun | KPI strategis | **T5** (dulu T2) |
| 67–71, 73 | MRLL; **prioritas di persimpangan untuk KBU**; informasi masyarakat; pengawasan & penegakan | TSP; portal | T3 (informasi publik), **T4** (prioritas angkutan umum) (dulu T3) |
| 74 | Dilarang memasang/memindahkan APILL tanpa **izin Kepala Dinas** | Referensi izin per aset | **T3** (dulu T1) |
...
| 232–235 | Sistem informasi transportasi Pemda; **dapat diakses masyarakat**; untuk penegakan hukum oleh Polri | Portal & API | **T3** (portal), **T5** (API) (dulu T2) |
| 237, 239 | Penilaian kinerja tahunan; kerja sama via perjanjian | Laporan tahunan; MoU | **T3** (dulu T2) |

### A.8 Pergub DKI 68/2021 (Jak Lingko)
| Pasal | Isi | Implikasi | Tahap |
|---|---|---|---|
| 1 angka 4–5 | Interoperabilitas & interkoneksi | Kriteria desain | T1 |
| 10(6)–(7) | 18 jenis data operasional (AVL, waktu tempuh, headway, kecelakaan & pelanggaran, aduan); **wajib kerahasiaan & keamanan** | Sumber AVL untuk TSP; keamanan | **T4** (dulu T3) |
...
| 15 | Monev; laporan ke Gubernur tiap 3 bulan | Laporan triwulan | **T3** (dulu T2) |
...
| Lamp. target 2029 | 60% angkutan umum; ≤90 menit; **≥30 km/jam**; cakupan 80%; ≤3 pindah moda | KPI | **T5** (dulu T2) |
...
| 20(2) | Dasar pemrosesan: persetujuan; perjanjian; **kewajiban hukum**; kepentingan vital; **tugas kepentingan umum/pelayanan publik/kewenangan berdasarkan peraturan**; kepentingan sah | Dasar hukum ITCS = pelayanan publik/kewenangan (UU 22/2009, PM 76) — dokumentasikan | **T3** (dulu T4) |
| 21 | Informasi legalitas, tujuan, jenis, retensi kepada subjek | Kebijakan privasi publik | **T3** (dulu T4) |
| 34 | **DPIA wajib** untuk: keputusan otomatis berdampak hukum, data spesifik, skala besar, pemantauan sistematis | ANPR/ETLE = pemantauan sistematis skala besar → DPIA | **T3** (data kamera Dishub), T4 (ANPR) (dulu T4) |
...
| SK 7234/2013 Bab II | Spesifikasi controller (≥8+8 SG, ≥4–16 program, 10 plan/hari, conflict monitor, manual panel, start-up), detektor (≥4 zona, gap & occupancy), DIS (RS-485, countdown), power, penandaan; perkiraan kebutuhan 5 tahun | Model data controller & spesifikasi pengadaan | **T3** (model data controller), **T4** (spesifikasi pengadaan) (dulu T1–T3) |
...
|---|---|---|---|
| C-01 | Atribut status jalan per simpang; flag jalan nasional; workflow persetujuan Dirjen/BPTJ | PM 49 Ps.28; PM 96 Ps.5; PM 76 Ps.19 | T1 (atribut), **T3** (alur persetujuan) (dulu T1) |
| C-02 | Referensi Keputusan Gubernur (lokasi & jenis APILL) per aset | PM 96 Lamp.I III; PP 32 Ps.24 | **T3** (dulu T1) |
| C-03 | Tanggal pasang → berlaku hukum +30 hari; tenggat pemasangan 60 hari | UU Ps.102 | **T3** (dulu T1) |
| C-04 | Izin Kepala Dinas sebelum aset APILL aktif/dipindah | Perda Ps.74 | **T3** (dulu T1) |
| C-05 | Sertifikasi & logo perhubungan per perangkat TI/APILL | PM 49 Ps.21, 25 | **T3** (atribut aset), **T4** (perangkat edge) (dulu T1) |
| C-06 | Pemeliharaan berkala ≤6 bulan + insidentil (re-timing) dengan alarm jatuh tempo | PM 49 Ps.41 | **T3** (dulu T1) |
| C-07 | Umur teknis ≤5 tahun; penilaian kinerja untuk penghapusan | PM 49 Ps.42 | **T3** (umur teknis), **T4** (penilaian kinerja aset) (dulu T1) |
| C-08 | Pemantauan keberadaan/lokasi/kondisi/fungsi perlengkapan jalan | PP 32 Ps.31; PM 96 | **T3** (dulu T1) |
| C-09 | ≥8 rencana siklus (TOD) sebagai fallback; mode tetap/semi-adaptif/adaptif/terkoordinasi | PM 49 Ps.11–16 | T1 (dasar), **T2** (≥8 jadwal rekomendasi), **T4** (fallback dan mode kendali di controller) (dulu T1) |
| C-10 | Algoritma siklus mempertimbangkan 12 aspek makro/mikro; terdokumentasi | PM 49 Ps.17 | T2 (mode optimasi), **T4** (algoritme adaptif) (dulu T2) |
| C-11 | Corridor grouping ATCS ≥3 simpang, ≤1 km; kelengkapan minimal | PM 96 Lamp.II.F.e | **T4** (dulu T2) |
| C-12 | Mode adaptif hanya bila detektor sehat | PM 96 Lamp.II.F.d | **T4** (dulu T3) |
| C-13 | Pemantau kecepatan/volume + media informasi (ITS) | PM 96 Lamp.II.F.g | T2 (volume), **T3** (kecepatan dan informasi publik) (dulu T2) |
| C-14 | Bus priority & hijau khusus angkutan umum/pejalan kaki | Perda Ps.70; PM 96 Lamp.II.A; PM 76 Ps.11 | **T4** (dulu T3) |
| C-15 | Override manual petugas Polri/TMC dengan audit log | UU Ps.104; PP 32 Ps.34–35 | **T4** (dulu T1) |
| C-16 | Preemption kendaraan hak utama | UU Ps.134–135 | T3 (deteksi kendaraan prioritas), **T4** (preemption) (dulu T3) |
| C-17 | Logika kotak kuning saat gridlock; syarat LOS ≥C | UU Ps.103; PM 96 Lamp.II.F.h | T3 |
| C-18 | Notifikasi kegagalan APILL ke Polri/TMC; insiden tercatat | PP 32 Ps.34–35; PM 76 Ps.7(4)e | **T3** (dari kamera), **T4** (dari controller) (dulu T1) |
| C-19 | Simulasi & sosialisasi sebelum kebijakan ditetapkan | PM 96 Lamp.I II.E, III.C | **T2** (simulasi), T3 (lengkap dengan sosialisasi) (dulu T3) |
| C-20 | Monev LOS sebelum/sesudah; laporan ke Forum LLAJ, Dirjen (tahunan), Gubernur (triwulan) | PM 96 Bab VI; UU Ps.98; Pergub 68 Ps.15 | T2 (dasar, laporan kajian), **T3** (sebelum-sesudah dan laporan wajib) (dulu T2) |
| C-21 | Template kajian ke Dirjen (kecepatan rata-rata & V/C) | PM 96 Lamp.III | **T3** (dulu T2) |
| C-22 | Integrasi ke pusat kendali SIK LLAJ Polri; data dapat diakses pembina | UU Ps.246–247 | T4 |
| C-23 | Portal/API publik (kecuali data pribadi) | UU Ps.250; Perda Ps.233 | **T3** (dashboard publik), **T5** (API publik) (dulu T2) |
| C-24 | ETLE: hanya bukti elektronik → Polri; tidak ada denda otomatis oleh Dishub | UU Ps.272, 260, 262; Perda Ps.95 | **T3** (bukti tanpa pelat), T4 (Back Office ETLE) (dulu T4) |
| C-25 | Integrasi pajak/uji emisi/TNKB via perjanjian & dasar hukum | PP 32 Ps.16; UU Ps.248; Pergub 68 Ps.13; Perda Ps.239 | T4 |
| C-26 | Kerahasiaan & keamanan data; data milik Pemprov; akses pihak ketiga dengan persetujuan | Pergub 68 Ps.10(7), 11 | T2 (dasar), **T3** (data Dishub) (dulu T2) |
| C-27 | Interoperabilitas/interkoneksi; integrasi Jakarta Smart City/JAKI | Pergub 68 Ps.1, 10–11 | **T3** (aduan kota), **T4** (sistem informasi pemda) (dulu T2) |
...
| C-30 | LOS A–F PM 96 & KPI 35/30 km/jam | PM 96; Perda Ps.8; Perpres 55 | T1 (LOS), **T5** (KPI kecepatan jaringan) (dulu T1) |
| C-31 | Info kualitas udara; pembatasan berdasar emisi; APILL tenaga surya dipertimbangkan | UU Ps.249; PM 96 Lamp.II.H | T4 |
| C-32 | Aksesibilitas: tombol pejalan kaki, isyarat suara | PM 49 Ps.33; PM 96 Lamp.II.C | **T3** (data penyeberang), **T4** (tombol pejalan kaki dan isyarat suara) (dulu T2) |
| C-33 | Kompetensi operator; unit kerja pengelola | PM 96 Ps.1(4); PM 76 Ps.21 | **T3** (operator), **T4** (sertifikasi) (dulu T2) |
| C-34 | Rencana aksi RITJ & koordinasi BPTJ (Bodetabek) | Perpres 55 Ps.4 | **T4** (dulu T2) |
| C-35 | Laporan monev triwulan (Jak Lingko) & penilaian kinerja transportasi tahunan | Pergub 68 Ps.15; Perda Ps.237 | **T3** (dulu T2) |
| C-36 | Sistem terbuka & berstandar (NTCIP/API terdokumentasi); semua perangkat online & dapat disetel dari ruang kendali; rekaman operasional & historis | PM 76 Ps.4(2), 7(3)–(4) | T1–T2 (format dan standar terbuka), **T4** (perangkat online dan dapat disetel dari ruang kendali) (dulu T1–T2) |
| C-37 | Dasar pemrosesan data pribadi terdokumentasi (pelayanan publik/kewenangan); kebijakan privasi | UU PDP Ps.20–21 | **T2** (dasar untuk rekaman), **T3** (data Dishub), T4 (ANPR) (dulu T4) |
| C-38 | DPIA sebelum ANPR/ETLE/face recognition; minimisasi & retensi | UU PDP Ps.16, 34 | **T3** (DPIA data kamera Dishub), T4 (diperbarui sebelum ANPR) (dulu T4) |
| C-39 | Pejabat PDP di organisasi pengguna; prosedur insiden ≤3×24 jam | UU PDP Ps.46, 53 | T4 |
| C-40 | Keamanan siber: RBAC, audit, enkripsi, kabinet terkunci/alarm (NEMA TS 8 sebagai referensi) | UU PDP Ps.35, 39; TSPH | T2 (dasar), **T4** (kabinet, mTLS) (dulu T2) |
| C-41 | Spesifikasi controller/detektor/DIS sesuai SK 7234 untuk pengadaan | SK 7234 Bab II | **T4** (dulu T3) |
