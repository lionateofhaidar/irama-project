...
|---|---|---|
| 05:30 | Serah terima shift; cek ringkasan malam: alarm perangkat, simpang flashing, komunikasi putus, transisi plan berlebih (Exhibit 8-16) | Ringkasan shift otomatis; watchdog (no data / max-out malam / stuck ped) (T1–T2) |
| 06:00 | Plan puncak pagi aktif lebih awal agar transisi selesai sebelum puncak (STM2 7-33) | Jadwal TOD & log transisi (T1) |
| 06:30–09:30 | Pantau koridor prioritas; intervensi manual bila antrean meluber (spillback); koordinasi Polantas di simpang kritis | Peta status + antrian/okupansi; tombol plan darurat/flush; catatan siapa-kapan-mengapa (T1 manual log → T2 semi-otomatis) |
| 09:30 | Tangani keluhan (CRM; SLA 3 jam): identitas, lokasi, waktu, berulang?, diagnosis lewat data sebelum kirim teknisi (Exhibit 8-17) | Rekreasi kejadian dari log (T2); form 7 langkah (T1) |
| 11:00 | Teknisi: work order detektor rusak (max-out terus-menerus); PM 6 bulanan | Work order & riwayat aset (T2) |
| 13:00 | Engineer: tinjau split failure/PCD koridor; usulkan perubahan split/offset; simulasi sebelum diterapkan (PM 96 wajib simulasi) | ATSPM & kalkulator PKJI (T2); digital twin (T4) |
| 15:30 | Siapkan plan puncak sore; cek event (unjuk rasa, kunjungan VVIP, banjir) | Manajer kejadian & plan alternatif (T2–T3) |
| 17:00–20:00 | Puncak sore; prioritas bus koridor BRT; preempt Damkar bila ada | TSP/EVP (T3–T4) |
| 21:00 | Laporan harian ke Kabid; unggah perubahan timing hanya saat teknisi tersedia (NCDOT) | Laporan otomatis; kunci jadwal upload (T1–T2) |
| Mingguan/bulanan | Laporan kinerja koridor (AoG, LOS, kecepatan), before–after, Forum LLAJ, triwulan ke Gubernur (Pergub 68) | Modul pelaporan (T1–T2) |
