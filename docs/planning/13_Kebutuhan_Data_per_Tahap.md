...
| D1.9 | **Contoh perhitungan resmi** | contoh 1 dan 2 PKJI 2023 Lampiran 12.5 (Formulir SA-I sampai SA-V, Tabel 12-9), contoh Kep. Dirjen 273/1996 Bab X, dan contoh MKJI 1997 | sudah ada di `docs/sources/`; nilai Formulir SA-IV dan SA-V PKJI dibaca dari PDF karena teks ekstraksinya bertumpuk | dua contoh PKJI 2023 dan satu contoh Dirjen 273/1996 | uji regresi kalkulator dengan cara di `15` bagian 4.4: contoh PKJI dijalankan dari data formulir; contoh Dirjen 273 dengan arus dan arus jenuh dari contoh (c = 70 s, g = 28/30 s, C = 824, DS = 0,44); contoh MKJI untuk mode pembanding di T2 |
